            ...
            var $select = $('.select-account').selectize({
                ...
                render: {
                    option: function(data, escape) {
                        return '<div><div class="optgroup-option"><span class="optgroup-iban">' + escape(data.iban) +'</span><span class="optgroup-amount">'+ escape(data.balance) + '$</span></div><span class="optgroup-name">' + escape(data.alias) + '</span></div>';
                    }
                }
            });
